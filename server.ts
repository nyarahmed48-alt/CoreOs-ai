...
/* =========================================================================
   ...
   The roster, the charter and the answering logic live in lab/agents.ts so
   the serverless deployments share them. This file adds only what is specific
   to running as a long-lived server: routing and in-memory rate limiting.
   ========================================================================= */
